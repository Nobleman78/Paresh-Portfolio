        ...
        >
            <div className="max-w-6xl mx-auto">
                <div className="mb-16">
                    ...
                    <p className="text-xl text-white dark:text-gray-300 max-w-5xl leading-relaxed">
                        A good thinker, team player and quick learner. Always try to learn something new so that I can apply those knowledge in my future career.
                    </p>
                </div>
                ...
                <div className="bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl">
                    {/* Tab Buttons */}
                    <div className="flex border-b border-gray-200 dark:border-gray-600 bg-gradient-to-r from-red-50 to-purple-50 dark:from-gray-700 dark:to-gray-800">
                        {tabs.map(tab => (
                            <button
                                key={tab.id}
                                ...
                                className={`flex-1 flex items-center justify-center gap-3 px-6 py-5 font-medium text-sm sm:text-base transition-all duration-300 
                                    ${activeTab === tab.id
                                        ? 'text-white bg-gradient-to-r from-blue-500 to-sky-500 shadow-lg'
                    ...
                    <div className="p-8 sm:p-10">
                        ...
                        {activeTab === 'personal' && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8" data-aos="fade-up">
                                {[
                                    { icon: <FiUser />, title: "Name", content: "Paresh Chakma" },
                                    { icon: <FiMail />, title: "Email", content: "pchakma952@gmail.com" },
                                    { icon: <FiMapPin />, title: "Address", content: "Khagrachari" },
                                    { icon: <FiPhone />, title: "Phone", content: "01893095824" }
                                ].map((item, index) => (
                                    <div
                                        key={index}
